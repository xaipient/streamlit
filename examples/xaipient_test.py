...
image = Image.open(
    '/Users/yz/Documents/GitHub/streamlit/examples/img/logo.png')
...
df2 = px.data.tips()
fig = px.density_heatmap(df2, x="total_bill", y="tip", nbinsx=20, nbinsy=20,
                         color_continuous_scale=["#B8C8F9", "#273346", "#E78CAE"])
fig.update_xaxes(title_font=dict(color='white'), tickfont=dict(color='white'))
fig.update_yaxes(linecolor='#273346', title_font=dict(color='white'),
